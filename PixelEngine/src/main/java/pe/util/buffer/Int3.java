...
public class Int3 extends Struct implements NativeResource
{
    ...
    /**
     * Returns a new {@link Int3} instance allocated with {@link BufferUtils}.
     */
    public static @NotNull Int3 create()
    {
        ByteBuffer container = BufferUtils.createByteBuffer(Int3.SIZEOF);
        return wrap(Int3.class, MemoryUtil.memAddress(container), container);
    }
    
    /**
     * Returns a new {@link Int3} instance for the specified memory address.
     */
    ...
    /**
     * Returns a new {@link Int3} instance for the specified memory address, but returns {@code null} if {@code address} is {@link MemoryUtil#NULL NULL}.
     */
    ...
    /**
     * Returns a new {@link Int3} instance allocated with {@link MemoryUtil#memAlloc memAlloc}. The instance must be explicitly freed.
     */
    public static @NotNull Int3 malloc()
    {
        return wrap(Int3.class, MemoryUtil.nmemAllocChecked(Int3.SIZEOF));
    }
    
    /**
     * Returns a new {@link Int3} instance allocated on the specified {@link MemoryStack}.
     *
     * @param stack the stack from which to allocate
     */
    public static @NotNull Int3 malloc(@NotNull MemoryStack stack)
    {
        return wrap(Int3.class, stack.nmalloc(Int3.ALIGNOF, Int3.SIZEOF));
    }
    
    /**
     * Returns a new {@link Int3} instance allocated with {@link MemoryUtil#memCalloc memCalloc}. The instance must be explicitly freed.
     */
    public static @NotNull Int3 calloc()
    {
        return wrap(Int3.class, MemoryUtil.nmemCallocChecked(1, Int3.SIZEOF));
    }
    
    /**
     * Returns a new {@link Int3} instance allocated on the specified {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param stack the stack from which to allocate
     */
    public static @NotNull Int3 calloc(@NotNull MemoryStack stack)
    {
    ...
    {
        return wrap(Buffer.class, MemoryUtil.memAddress(container), container.remaining() / Int3.SIZEOF);
    }
    ...
    {
        return wrap(Buffer.class, MemoryUtil.nmemAllocChecked(__checkMalloc(capacity, Int3.SIZEOF)), capacity);
    }
     ...
     * @param capacity the buffer capacity
     */
    public static @NotNull Int3.Buffer malloc(int capacity, @NotNull MemoryStack stack)
    {
    ...
    {
        return wrap(Buffer.class, MemoryUtil.nmemCallocChecked(capacity, Int3.SIZEOF), capacity);
    }
     ...
     * @param capacity the buffer capacity
     */
    public static @NotNull Int3.Buffer calloc(int capacity, @NotNull MemoryStack stack)
    {
    ...
    public Int3(@NotNull ByteBuffer container)
    {
        super(MemoryUtil.memAddress(container), __checkContainer(container, Int3.SIZEOF));
    }
